...
- **[Arotake](https://github.com/jankazil/Arotake)**  
  Command-line tool and application programming interface (API) that automate evaluating
...
- **[hrrr-data](https://github.com/jankazil/hrrr-data)**  
  Command-line tool and API that automate accessing, downloading, and processing NOAA High-Resolution Rapid Refresh (HRRR) forecast data from NOAA’s public AWS S3 bucket.

- **[`lcd-v2-data`](https://github.com/jankazil/lcd-v2-data)**  
  Command-line tool and API that automate downloading, filtering, and processing NOAA Local Climatological Data version 2 ([LCD v2](https://www.ncei.noaa.gov/access/search/data-search/local-climatological-data-v2)) observations for
...
- **[isd-lite-data](https://github.com/jankazil/isd-lite-data)**  
  Command-line tool and API that automate downloading, filtering, and processing NOAA Integrated Surface Database Lite ([ISD-Lite](https://www.ncei.noaa.gov/access/search/data-search/global-hourly)) observations for
